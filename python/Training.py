...
for UseIMage in lst_useImage:
    for run in [0]:
        for ImagetoTest in [1]:
            ...
            PltNAme = 'NEW_SmallUnet1TEST16INV_FEATURES_CONV=' + str(UseConv) + '_LR=' + str(learning_Rate) + '_100_sce_' + str(
            ...
            #######                Save Model
            model.save('DataFiles/'+PltNAme+'.h5')
...
pltName = 'DataFiles/'+PltNAme+'.png'
print('E:\AutomatedTracing\AutomatedTracing\Python\MachineLeatningAutomatedTracing/'+pltName)
